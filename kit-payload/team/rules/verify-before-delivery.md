...
2. Treat CONFIRMED findings as fixes. Treat PLAUSIBLE findings as judgment calls for the owner.
3. "No confirmed issues" is a valid, expected outcome. Do not invent changes to justify the review.
